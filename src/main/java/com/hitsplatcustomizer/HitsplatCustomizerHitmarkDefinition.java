...
final class HitsplatCustomizerHitmarkDefinition
{
	...
	private HitsplatCustomizerHitmarkDefinition(
		int firstSpriteId,
		int middleSpriteId,
		int secondSpriteId,
		int lastSpriteId,
	...
	static HitsplatCustomizerHitmarkDefinition load(Client client, int hitsplatType)
	{
		try
		{
			...
			while (true)
			{
				...
				if (opcode == 0)
				{
					return decoded.toDefinition(hitsplatType);
				}
	...
	private static HitsplatCustomizerHitmarkDefinition fallback(int hitsplatType)
	{
		return new HitsplatCustomizerHitmarkDefinition(
	...
	private static final class DecodedDefinition
	{
		...
		private HitsplatCustomizerHitmarkDefinition toDefinition(int hitsplatType)
		{
			if (firstSpriteId < 0 && middleSpriteId < 0 && secondSpriteId < 0 && lastSpriteId < 0)
			{
				firstSpriteId = fallbackSpriteId(hitsplatType);
			}
