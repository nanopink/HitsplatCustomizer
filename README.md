...
Default setting preserves the original game mechanics.
...
You can use my own preset.
The full lifetime of the animation is less than a full tick, which makes it ideal for real time damage checking.
